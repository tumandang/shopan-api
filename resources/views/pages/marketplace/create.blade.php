...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Add Marketplace</h1>
        <p class="mt-2 text-sm text-gray-600">Create a new marketplace listing</p>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1">
                                <div class="relative">
                                    <input type="file" name="logo"  id="logo"  accept="image/*" class="hidden"  onchange="previewLogo(event)" required>
                                    <label for="logo" 
                        ...
                        <div class="relative">
                            <select name="category_id" 
                                ...
                                @foreach($categories as $c)
                                    <option value="{{ $c->id }}" 
                                            {{ (old('category_id', $marketplace->categories->first()->id ?? null) == $c->id) ? 'selected' : '' }}
                                            class="py-2">
                                        {{ $c->name }}
                                    </option>
                                @endforeach
                        ...
                        <div class="mt-3 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                            <div class="flex">
                                ...
                                <div class="text-sm text-yellow-700">
                                    ...
                                    <a href="{{ route('categories.create') }}" class="font-medium underline hover:text-yellow-800">
